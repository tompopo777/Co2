...
class personnel_inventory(models.Model):
    ...
    WKnum_january = models.FloatField(default=0)
    WKnum_february = models.FloatField(default=0)
    WKnum_march = models.FloatField(default=0)
    WKnum_april = models.FloatField(default=0)
    WKnum_may = models.FloatField(default=0)
    WKnum_june = models.FloatField(default=0)
    WKnum_july = models.FloatField(default=0)
    WKnum_august = models.FloatField(default=0)
    WKnum_september = models.FloatField(default=0)
    WKnum_october = models.FloatField(default=0)
    WKnum_november = models.FloatField(default=0)
    WKnum_december = models.FloatField(default=0)
    image_note = models.CharField(max_length=30, null=True)
