...
class combustion_equipment(models.Model):
    ...
    heat_january = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_february = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_march = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_april = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_may = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_june = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_july = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_august = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_september = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_october = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_november = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    heat_december = models.DecimalField(max_digits=20, decimal_places=4, null=True)
    image_note = models.CharField(max_length=30, null=True)
    message_board = models.CharField(max_length=255, null=True)
    company_id = models.IntegerField()
