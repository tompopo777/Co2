...
class OFform(forms.ModelForm):
    ...
    class Meta:
        model = official_car
        fields = ('vehicle_type', 'device_id', 'fuel_type', 'period_starttime', 'period_endtime', 'department', 'january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december', 'image_note', 'image_path', 'urea', 'urea_add_quantity', 'urea_add_date', 'urea_image_note', 'urea_image_path')
        widgets = {
