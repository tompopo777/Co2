...
class CEform(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'heat_january': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_february': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_march': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_april': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_may': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_june': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_july': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_august': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_september': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_october': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_november': forms.TextInput(attrs={'class': 'col-6'}),
            'heat_december': forms.TextInput(attrs={'class': 'col-6'}),
